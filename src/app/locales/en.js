...
const en = {
  ...
  "page": {
    ...
    "content": "Jean-Baptiste CAPODIMACCI, grandson and son of a fisherman, grew up with the sea. He knows the secret passages that only a local child can discover. With him, immerse yourself in the heart of the spectacular landscapes of his native region: the Scandola nature reserve, the village of Girolata, the coves of Piana… During the day or at sunset, choose the circuit that suits you.",
    "title2": "Embark",
    "subtitle4": "Welcome",
    "subtitle5": "on board",
    "subtitle6": "of Sacha",
  ...
  "cards": {
    "grandTour": {
      ...
      "description": "Capu Rossu - Calanques de Piana (10 min swim) - Porto Gulf - Girolata (30 min stop) - Scandola",
