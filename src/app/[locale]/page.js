    ...
    <main>
      ...
      <section className="flex flex-col mt-8 px-4 gap-4 max-w-md mx-auto lg:hidden">
        ...
        <Card
          ...
          imageSrc="/images/calanques-piana.webp"
        />
        <Card
        ...
        />
        <Card
          tourKey="grandTourSunset"
          imageSrc="/images/grandtour-sunset.webp"
        />
        <Card
          tourKey="calanquesPianaSunset"
          imageSrc="/images/calanques-piana-sunset.webp"
        />
        <Card
          tourKey="scandolaGirolataSunset"
          imageSrc="/images/scandola-girolata-sunset.webp"
        />
      </section>
      <EmbarkSection />
      <VideoLagula />
