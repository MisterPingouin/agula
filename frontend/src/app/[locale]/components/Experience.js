...
<p className="font-title text-25px text-center leading-29px">{t("title")}</p>
<p className="ont-title text-25px text-center leading-29px">{t("title2")}</p>
{/* Mobile Experience */}
<div className="flex justify-center items-center mt-10 gap-8 mb-12">
...
<p className="font-title font-bold text-green-2 text-10px">{t("more")}</p>
<Image
