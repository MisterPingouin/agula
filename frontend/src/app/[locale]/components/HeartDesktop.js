...
export default function HeartDesktop() {
    ...
    return (
        <section className="flex flex-col justify-center items-center leading-tight px-2 mb-6 md:hidden">
            <h5 className="font-subtitle text-50px text-green-2">{t("title")}</h5>
